...
**/
typedef BOOLEAN(EFIAPI *MS_SWM_CLIENT_NOTIFICATION_CALLBACK)(IN VOID *Context);
...
--*/
typedef EFI_STATUS(EFIAPI *MS_SWM_REGISTER_CLIENT)(
...
typedef EFI_STATUS(EFIAPI *MS_SWM_UNREGISTER_CLIENT)(
    IN MS_SIMPLE_WINDOW_MANAGER_PROTOCOL *This,
    IN EFI_HANDLE ImageHandle);

typedef EFI_STATUS(EFIAPI *MS_SWM_ACTIVATE_WINDOW)(
    IN MS_SIMPLE_WINDOW_MANAGER_PROTOCOL *This,
    IN EFI_HANDLE ImageHandle,
    IN BOOLEAN MakeActive);

typedef EFI_STATUS(EFIAPI *MS_SWM_SET_WINDOW_FRAME)(
    IN MS_SIMPLE_WINDOW_MANAGER_PROTOCOL *This,
    IN EFI_HANDLE ImageHandle,
    IN SWM_RECT *FrameRect);

typedef EFI_STATUS(EFIAPI *MS_SWM_BLT_WINDOW)(
    IN MS_SIMPLE_WINDOW_MANAGER_PROTOCOL *This,
    IN EFI_HANDLE ImageHandle,
...
typedef EFI_STATUS(EFIAPI *MS_SWM_STRING_TO_WINDOW)(
    IN MS_SIMPLE_WINDOW_MANAGER_PROTOCOL *This,
    IN EFI_HANDLE ImageHandle,
...
typedef EFI_STATUS(EFIAPI *MS_SWM_ENABLE_MOUSE_POINTER)(
    IN MS_SIMPLE_WINDOW_MANAGER_PROTOCOL *This,
    IN BOOLEAN bEnablePointer);

typedef EFI_STATUS(EFIAPI *MS_SWM_WAIT_FOR_EVENT)(
