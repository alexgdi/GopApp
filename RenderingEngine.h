...
**/
typedef EFI_STATUS(EFIAPI *MS_SRE_SET_MOUSE_POINTER)(IN MS_RENDERING_ENGINE_PROTOCOL *This,
...
**/
typedef EFI_STATUS(EFIAPI *MS_SRE_MOVE_MOUSE_POINTER)(
    IN MS_RENDERING_ENGINE_PROTOCOL *This,
    IN UINT32 OrigX,
    IN UINT32 OrigY);

typedef EFI_STATUS(EFIAPI *MS_SRE_CREATE_SURFACE)(
    IN MS_RENDERING_ENGINE_PROTOCOL *This,
    IN EFI_HANDLE ImageHandle,
    IN SWM_RECT SurfaceFrame,
    OUT EFI_EVENT *PaintEvent);

typedef EFI_STATUS(EFIAPI *MS_SRE_RESIZE_SURFACE)(
    IN MS_RENDERING_ENGINE_PROTOCOL *This,
    IN EFI_HANDLE ImageHandle,
    IN SWM_RECT *SurfaceFrame);

typedef EFI_STATUS(EFIAPI *MS_SRE_ACTIVATE_SURFACE)(
    IN MS_RENDERING_ENGINE_PROTOCOL *This,
    IN EFI_HANDLE ImageHandle,
    IN BOOLEAN Active);

typedef EFI_STATUS(EFIAPI *MS_SRE_DELETE_SURFACE)(
    IN MS_RENDERING_ENGINE_PROTOCOL *This,
    IN EFI_HANDLE ImageHandle);
...
typedef EFI_STATUS(EFIAPI *MS_SRE_SET_MODE_SURFACE)(
    IN MS_RENDERING_ENGINE_PROTOCOL *This,
    IN EFI_HANDLE ImageHandle,
